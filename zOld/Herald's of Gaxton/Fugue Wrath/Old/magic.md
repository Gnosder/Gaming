...
| :--------------------------------------------------- | :--------------- | :------- |
| Writing a Scroll                                     | Force x 1.5 days | 50sp/day |
...
| Researching a Spell on the Spell List                | Force x 5 days   | 25sp/day |
| Researching a New Spell                              | Force x 7 days   | 30sp/day |
...
Elements
    ...
    Radiant
        Bolsters life, counter to necrotic
    Acid
        Also poison. Can damage AC and inflict poison.
    Force
        Can ignore armor and bypass some magic effects
...
Force 1:
    ...
    Thanergic Lance
        ...
        When learned choose one necromantic school (Bone, Blood, Spirit), this choice may not be changed, but the spell may be learned multiple times and different school can be chosen each time.
        You hurl a bolt of the chosen type at a target that deals 1d10 damage on a hit. This spell always targets AC.
        Higher Forces: Add 1d10 damage for each force after the first. At force 3 or higher gain school effects.
    Servants of Bone
    Speak with Spirits
    Raise Skeleton
    Armor of Bones
